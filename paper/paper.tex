...
Some or all data, models, or code generated or used during the study are available in a repository online in accordance with funder data retention policies. The EPANET-BB source code, benchmark network files, experiment configurations, and processed result tables used to support the findings of this study are available at \url{https://github.com/michaelsouza/epanet-bb}.
